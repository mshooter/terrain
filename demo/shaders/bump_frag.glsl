...
uniform float texCoordScale = 5.0;
...
void main()
{
    ...
    vec3 lightColor = (
            ...
            Light.Ld * Material.Kd * max( dot(s, np), 0.5 ) +
            Light.Ls * Material.Ks * pow( max( dot(r,v), 0.5 ), Material.Shininess ));
